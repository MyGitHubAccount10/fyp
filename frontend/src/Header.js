...
const Header = () => {
    ...
    // Check for user in localStorage to determine login status
    ...
    const handleLogout = () => {
        ...
        // Reloading the page is a simple way to reset state across the app
        window.location.href = '/'; 
    };

    // The unused DropdownMenu component has been removed
                        ...
                        <div className="profile-dropdown-box">
                            {user ? (
                                ...
                                <>
                                    ...
                                    <div className="profile-dropdown-item" onClick={handleLogout} style={{ cursor: 'pointer' }}>
                                        <LogoutIcon />
                                        <span>Logout</span>
                                    </div>
                                </>
